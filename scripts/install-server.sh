#!/usr/bin/env bash
# install-server.sh — Set up the Scrunchy standalone server.
#
# Usage:
...
echo ""
echo "===================================="
echo "  Scrunchy Server Ready"
echo "===================================="
echo ""
echo "Start the server (with Web UI):"
echo ""
echo "  SCRUNCHY_SERVER_TOKEN=$TOKEN \\"
echo "  SCRUNCHY_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  SCRUNCHY_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
...
echo "  SCRUNCHY_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  SCRUNCHY_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  SCRUNCHY_RPC_HOST=0.0.0.0 \\"
echo "  SCRUNCHY_RPC_PORT=9100 \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
...
echo "  SCRUNCHY_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  SCRUNCHY_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  SCRUNCHY_RPC_TLS_CERT=/path/to/cert.pem \\"
echo "  SCRUNCHY_RPC_TLS_KEY=/path/to/key.pem \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
