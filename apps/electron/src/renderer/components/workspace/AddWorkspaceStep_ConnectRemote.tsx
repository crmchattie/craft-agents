...
/**
 * AddWorkspaceStep_ConnectRemote - Connect to a remote Scrunchy Server
 *
 * Two paths:
...
export function AddWorkspaceStep_ConnectRemote({
  ...
  const handleConnect = useCallback(async () => {
    ...
    if (!homeDir) return
    const defaultBasePath = `${homeDir}/.scrunchy/workspaces`
    ...
    <AddWorkspaceContainer>
      ...
      <AddWorkspaceStepHeader
        ...
        description={isReconnectMode
          ...
          : "Connect to a remote Scrunchy Server for this workspace."}
      />
