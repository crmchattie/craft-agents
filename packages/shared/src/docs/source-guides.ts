 ...
 * Guides are now served exclusively via the scrunchy-docs MCP server.
 *
 ...
 * Use the scrunchy-docs MCP server to search for setup guides.
 *
 * Example: mcp__scrunchy-docs__SearchScrunchys({ query: "github source setup guide" })
 */
