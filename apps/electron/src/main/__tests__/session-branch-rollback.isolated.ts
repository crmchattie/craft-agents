...
mock.module('@scrunchy/shared/config', () => ({
...
mock.module('@scrunchy/shared/workspaces', () => ({
  loadWorkspaceConfig: () => ({
    defaults: {
      permissionMode: 'ask',
      thinkingLevel: 'medium',
...
mock.module('@scrunchy/shared/agent', () => ({
...
mock.module('@scrunchy/shared/agent/backend', () => ({
...
mock.module('@scrunchy/shared/sources', () => ({
...
mock.module('@scrunchy/shared/automations', () => ({
...
mock.module('@scrunchy/shared/sessions', () => ({
  listSessions: () => [],
...
const { SessionManager } = await import('@scrunchy/server-core/sessions')
