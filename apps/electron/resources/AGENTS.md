...
This folder contains assets that are bundled with the Electron app and synced to the user's `~/.scrunchy/` directory on every launch.
...
|-------------|-----------|---------------|
| `docs/` | `~/.scrunchy/docs/` | Always overwrite on launch |
| `themes/` | `~/.scrunchy/themes/` | Always overwrite on launch |
| `permissions/` | `~/.scrunchy/permissions/` | Always overwrite on launch |
| `tool-icons/` | `~/.scrunchy/tool-icons/` | Always overwrite on launch |
| `config-defaults.json` | `~/.scrunchy/config-defaults.json` | Always overwrite on launch |
