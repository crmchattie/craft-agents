 ...
 *
 * Watched paths:
 * - ~/.scrunchy/config.json - Main app configuration
 * - ~/.scrunchy/preferences.json - User preferences
 * - ~/.scrunchy/theme.json - App-level theme overrides
 * - ~/.scrunchy/themes/*.json - Preset theme files (app-level)
 * - ~/.scrunchy/workspaces/{slug}/ - Workspace directory (recursive)
...
export interface ConfigWatcherCallbacks {
  ...
  /** Called when app-level default permissions change (~/.scrunchy/permissions/default.json) */
...
export class ConfigWatcher {
  ...
  /**
   * Watch app-level themes directory (~/.scrunchy/themes/)
   */
  ...
  /**
   * Watch app-level permissions directory (~/.scrunchy/permissions/)
