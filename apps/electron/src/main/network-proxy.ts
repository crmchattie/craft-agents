...
import { getNetworkProxySettings, setNetworkProxySettings } from '@scrunchy/shared/config/storage';
import type { NetworkProxySettings } from '@scrunchy/shared/config/types';
