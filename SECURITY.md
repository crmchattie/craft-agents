...
We take security seriously. If you discover a security vulnerability in Scrunchy, please report it responsibly.

### How to Report

**Please do NOT report security vulnerabilities through public GitHub issues.**

Instead, please send an email to: **cory@scrunchy.ai**
...
- The Scrunchy desktop application
- The `@scrunchy/*` npm packages
- Official Scrunchy repositories
