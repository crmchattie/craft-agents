...
import type { StoredAttachment, StoredMessage } from '@scrunchy/core/types';
...
import type { Workspace, AuthType } from '@scrunchy/core/types';
...
const FALLBACK_CONFIG_DEFAULTS: ConfigDefaults = {
  version: '1.0',
  description: 'Default configuration values for Scrunchy',
  defaults: {
...
/**
 * Load config defaults from ~/.scrunchy/config-defaults.json
...
export function ensureConfigDir(): void {
  ...
  // Initialize bundled docs (creates ~/.scrunchy/docs/ with sources.md, agents.md, permissions.md)
  initializeDocs();
...
export type { StoredAttachment, StoredMessage } from '@scrunchy/core/types';
...
/**
 * Get the path to the app-level theme override file (~/.scrunchy/theme.json).
 */
 ...
 * Preset themes are stored at ~/.scrunchy/themes/
 */
...
/**
 * Returns the path to the tool-icons directory: ~/.scrunchy/tool-icons/
 */
