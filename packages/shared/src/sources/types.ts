 ...
 *
 * File structure:
 * ~/.scrunchy/workspaces/{workspaceId}/sources/{sourceSlug}/
...
export interface LoadedSource {
  ...
  /** Absolute path to workspace folder (e.g., ~/.scrunchy/workspaces/xxx) */
  ...
  /**
   * Whether this is a built-in source (e.g., scrunchy-docs).
