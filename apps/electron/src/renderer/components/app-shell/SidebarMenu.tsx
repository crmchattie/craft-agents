...
import { getDocUrl, type DocFeature } from '@scrunchy/shared/docs/doc-links'
...
export function SidebarMenu({
  ...
  if (type === 'newSession') {
    return (
      <MenuItem onClick={() => window.electronAPI.openUrl('scrunchy://action/new-session?window=focused')}>
