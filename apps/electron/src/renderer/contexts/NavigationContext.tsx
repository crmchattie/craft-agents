...
import { parsePermissionMode } from '@scrunchy/shared/agent/mode-types'
...
export { isSessionsNavigation, isSourcesNavigation, isSettingsNavigation, isSkillsNavigation, isAutomationsNavigation, isInboxNavigation, isTasksNavigation, isCalendarNavigation }
